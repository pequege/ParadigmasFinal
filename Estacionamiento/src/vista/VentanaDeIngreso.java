...
public class VentanaDeIngreso extends javax.swing.JDialog {
    ...
    public JLabel getjLabelCabina() {
        return jLabelCabina;
    }
    public JLabel getjLabelCantidadPuertas() {
        return jLabelCantidadPuertas;
    }
    public JLabel getjLabelCilindrada() {
        return jLabelCilindrada;
    }				
    ...
    private void initComponents() {
        ...
        jLabelCabina = new javax.swing.JLabel();
        ...
        jLabelCilindrada.setText("cilindradas");

        servLava.setText("Servicio de Lavado");

        jLabelCantidadPuertas.setText("cant. puertas");

        jLabel6.setText("LUGAR:");

        jLabelCabina.setText("tipo cabina");
  ...
  private void cilindradaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cilindradaActionPerformed
    ...
    private javax.swing.JLabel jLabelCabina;
